...
class VerticalLayout extends EventDispatcher implements IVariableVirtualLayout, ITrimmedVirtualLayout
{
	 ...
	 * @private
	 */
	public function set_hasVariableItemDimensions(value:Bool):Void
	{
	 ...
	 * @private
	 */
	public function set_distributeHeights(value:Bool):Void
	{
	 ...
	 * @private
	 */
	public function set_beforeVirtualizedItemCount(value:Int):Void
	{
	 ...
	 * @private
	 */
	public function set_afterVirtualizedItemCount(value:Int):Void
	{
	 ...
	 * @private
	 */
	public function set_scrollPositionVerticalAlign(value:String):Void
	{
	 ...
	 * @private
	 */
	private function validateItems(items:Vector.<DisplayObject>, justifyWidth:Float, distributedHeight:Float):Void
	{
	 ...
	 * @private
	 */
	private function calculateDistributedHeight(items:Vector.<DisplayObject>, explicitHeight:Float, minHeight:Float, maxHeight:Float):Float
	{
		var itemCount:Int = items.length;
	 ...
	 * @private
	 */
	private function applyPercentHeights(items:Vector.<DisplayObject>, explicitHeight:Float, minHeight:Float, maxHeight:Float):Void
	{
