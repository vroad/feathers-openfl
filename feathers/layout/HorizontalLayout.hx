...
class HorizontalLayout extends EventDispatcher implements IVariableVirtualLayout, ITrimmedVirtualLayout
{
	 ...
	 * @default false
	 */
	public function get distributeWidths():Bool
	{
	 ...
	 * @private
	 */
	public function set_distributeWidths(value:Bool):Void
	{
	 ...
	 * @private
	 */
	public function set_scrollPositionHorizontalAlign(value:String):Void
	{
